...
function Sidebar() {
  ...
  return (
    <aside className=" fixed flex flex-col w-[300px] max-w-[350px] min-h-screen py-2 justify-between px-4 bg-indigo-950 text-white rounded-r-lg">
      ...
      <button className="mb-4 w-full py-2 px-3 rounded-lg border flex items-center hover:font-semibold gap-3 hover:bg-lime-100 hover:text-black transition-all ease-linear duration-200 cursor-pointer">
