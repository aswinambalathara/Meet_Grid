...
function AdminEventManagement() {
  ...
  return (
    <div className="w-full h-full">
      ...
      <div className="overview grid grid-cols-4 gap-3 mb-3">
        <Card className="min-h-36 bg-cyan-400/50">
          <CardContent className="p-4 flex flex-col gap-2 text-slate-900">
            ...
            <Button className="text-slate-900" variant={"link"}>
              Show All Events
            </Button>
          </CardContent>
        </Card>
      ...
      <div className="event-list mt-10 flex flex-col gap-3">
        <div className="search relative max-w-52 self-end">
          <Input
            placeholder="Search Event"
            type="search"
            className="w-full bg-slate-50 overflow-auto"
          />
          <i className="fa-solid fa-magnifying-glass absolute right-2 top-3 text-sm" />
        </div>
        <Table className="bg-white/70 rounded border-spacing-5">
          <TableHeader>
            <TableRow>
