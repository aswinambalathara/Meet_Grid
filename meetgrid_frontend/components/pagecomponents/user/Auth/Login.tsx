...
function Login() {
  ...
  const handleOAuthLogin = () => {
    window.location.href = `${USER_URL}/auth/google`;
  };
        ...
        <div className="user-auth-background md:w-3/4 min-h-[700px] rounded-xl flex flex-col-reverse md:flex-row items-center justify-between py-16 px-4 lg:px-28 md:py-0">
          ...
          >
            ...
            <div className="mb-3 flex gap-2 items-center">
              <div
                className="bg-slate-200 hover:bg-slate-300 cursor-pointer h-10 p-2 w-10 rounded-full shadow-md"
              ...
              <div className="cursor-pointer h-10 w-10 p-2 bg-blue-500 hover:bg-blue-400 rounded-full transition ease duration-300">
                <EnterEmail
